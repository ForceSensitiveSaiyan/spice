  ...
  return (
    <div className="border border-stone-200 dark:border-stone-700 rounded-lg overflow-hidden">
      <button
        ...
        className="w-full flex items-center justify-between px-4 py-3 text-left hover:bg-stone-50 dark:hover:bg-stone-800 transition-colors"
      >
        <span className="font-semibold">Why This Works</span>
        <span className="text-stone-400 dark:text-stone-500 text-sm">{open ? "collapse" : "expand"}</span>
      </button>
      {open && (
